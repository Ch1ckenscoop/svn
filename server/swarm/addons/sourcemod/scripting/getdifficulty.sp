...
#define PL_VERSION "1.0.5"    //softcopy: corrected brutal missing alert messages.
...
public PrintDifficulty(client)
{
	...
	{
		case 1:
			PrintToChat(client, "This server is set to Easy.");
		case 2:
			PrintToChat(client, "This server is set to Normal.");
		case 3:
			PrintToChat(client, "This server is set to Hard.");
		case 4:
			PrintToChat(client, "This server is set to Insane.");
		case 5:
			PrintToChat(client, "This server is set to Brutal.");	//softcopy: add brutal msg
		default:
...
public PrintDiffAll()
{
	...
	{
		case 1:
			PrintToChatAll("This server is now on Easy.");
		case 2:
			PrintToChatAll("This server is now on Normal.");
		case 3:
			PrintToChatAll("This server is now on Hard.");
		case 4:
			PrintToChatAll("This server is now on Insane.");
		case 5:
			PrintToChatAll("This server is now on Brutal.");		//softcopy: add brutal msg
		default:
			PrintToServer("Something broke.");
	}
}
	
//Returns the current skill level as an integer; 1=Easy, 2=Normal, 3=Hard, 4=Insane, 5=Brutal	//softcopy:
public GetSkill()
{
