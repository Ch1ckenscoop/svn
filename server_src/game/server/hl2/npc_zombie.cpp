...
// softcopy:
//
// npc_zombie.cpp has been ported from Valve source-sdk-2013.
// 
//============================================================//
...
ConVar sk_zombie_health( "sk_zombie_health", "100", FCVAR_CHEAT | FCVAR_CCOOP, "Set npc_zombie health" );
ConVar asw_npc_zombie_color("asw_npc_zombie_color", "255 255 255", FCVAR_NONE, "Sets the color of npc_zombie.");
ConVar asw_npc_zombie_color2("asw_npc_zombie_color2", "255 255 255", FCVAR_NONE, "Sets the color of npc_zombie.");
ConVar asw_npc_zombie_color2_percent("asw_npc_zombie_color2_percent", "0.0", FCVAR_NONE, "Sets the percentage of npc_zombie color",true,0,true,1);
ConVar asw_npc_zombie_color3("asw_npc_zombie_color3", "255 255 255", FCVAR_NONE, "Sets the color of npc_zombie.");
...
void CZombie::Precache( void )
{
	...
	//softcopy: replaced sounds
	//PrecacheScriptSound( "Zombie.FootstepRight" );
	//PrecacheScriptSound( "Zombie.FootstepLeft" );
	//PrecacheScriptSound( "Zombie.FootstepLeft" );	//duplicated
	PrecacheScriptSound( "ASW_Boomer.FootstepWalk" );
	...
	PrecacheScriptSound( "ASW_Boomer.MeleeWhoosh" );
...
void CZombie::FootstepSound( bool fRightFoot )
{
	...
	EmitSound( "ASW_Boomer.FootstepWalk" );
}
...
void CZombie::AttackMissSound( void )
{
	...
	EmitSound( "ASW_Boomer.MeleeWhoosh");
}
...
{
	//EmitSound( "Zombie.Alert" );	//softcopy:
...
void CZombie::SetZombieModel( void )
{
	...
	SetBodygroup( ZOMBIE_BODYGROUP_HEADCRAB, m_fIsHeadless );	//softcopy: want to see the bloody head
...
void CZombie::Event_Killed( const CTakeDamageInfo &info )
{
	...
	//EmitSound( filter, entindex(), "NPC_Zombie.NoSound" );
