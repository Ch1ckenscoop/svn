...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	//softcopy:
	ADD_ACTIVITY_TO_SR( ACT_DRONE_TINY_FLINCH );
	ADD_ACTIVITY_TO_SR( ACT_DRONE_BURROW_OUT );
	ADD_ACTIVITY_TO_SR( ACT_DRONE_BURROW_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_BURROW_OUT );
	ADD_ACTIVITY_TO_SR( ACT_BURROW_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_ANTLION_RUN_AGITATED );
