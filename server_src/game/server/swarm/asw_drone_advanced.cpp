...
float CASW_Drone_Advanced::GetDamage()	//Ch1ckensCoop: Easy customizing of alien damages.
{
...
void CASW_Drone_Advanced::HandleAnimEvent( animevent_t *pEvent )
{
	...
	{
		float fDamage = MAX(3.0f, ASWGameRules()->ModifyAlienDamageBySkillLevel(GetDamage()));
