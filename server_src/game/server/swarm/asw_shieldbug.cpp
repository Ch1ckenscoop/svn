...
ConVar asw_shieldbug_scalemod("asw_shieldbug_scalemod", "1.0", FCVAR_NONE, "Sets the scale of normal new model shieldbugs.",true,0,true,1.5);
ConVar asw_shieldbug_scalemod_percent("asw_shieldbug_scalemod_percent", "1.0", FCVAR_NONE, "Sets the percentage of normal new model shieldbugs scale.",true,0,true,1);
...
ConVar asw_shieldbug_beta_scalemod("asw_shieldbug_beta_scalemod", "1.0", FCVAR_NONE, "Sets the scale of normal beta model shieldbugs.",true,0,true,1.5);
ConVar asw_shieldbug_beta_scalemod_percent("asw_shieldbug_beta_scalemod_percent", "1.0", FCVAR_NONE, "Sets the percentage of normal beta shieldbugs scale.",true,0,true,1);
...
{	
	if ( scheduleType == SCHED_MELEE_ATTACK1 )
	{
		...
		if (bOldShieldBug)
		{
			//this var is used to leave beta shieldbug attacking mode (so we'll do a charge if we haven't done one for a while)
...
{
	BaseClass::ASW_Ignite(flFlameLifetime, flSize, pAttacker, pDamagingWeapon );
}
