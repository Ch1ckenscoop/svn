...
ConVar asw_parasite_safe_scalemod("asw_parasite_safe_scalemod", "1.0", FCVAR_NONE, "Sets the scale of normal defanged parasites.",true,0,true,1.5);
ConVar asw_parasite_safe_scalemod_percent("asw_parasite_safe_scalemod_percent", "1.0", FCVAR_NONE, "Sets the percentage of normal defanged parasites scale.",true,0,true,1);
...
ConVar asw_parasite_scalemod("asw_parasite_scalemod", "1.0", FCVAR_NONE, "Sets the scale of normal parasites.",true,0,true,1.5);
ConVar asw_parasite_scalemod_percent("asw_parasite_scalemod_percent", "1.0", FCVAR_NONE, "Sets the percentage of normal parasites scale.");
...
ConVar asw_parasite_beta_scalemod("asw_parasite_beta_scalemod", "1.0", FCVAR_NONE, "Sets the scale of normal beta model parasites.",true,0,true,1.5);
ConVar asw_parasite_beta_scalemod_percent("asw_parasite_beta_scalemod_percent", "1.0", FCVAR_NONE, "Sets the percentage of normal beta parasites scale.",true,0,true,1);
