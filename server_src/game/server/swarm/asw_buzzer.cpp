...
ConVar asw_buzzer_scalemod("asw_buzzer_scalemod", "1.0", FCVAR_NONE, "Sets the scale of normal buzzers.",true,0,true,1.5);
ConVar asw_buzzer_scalemod_percent("asw_buzzer_scalemod_percent", "1.0", FCVAR_NONE, "Sets the percentage of normal buzzers scale.",true,0,true,1);
...
ConVar asw_buzzer_beta_scalemod("asw_buzzer_beta_scalemod", "1.0", FCVAR_NONE, "Sets the scale of normal beta model buzzers.",true,0,true,2);
ConVar asw_buzzer_beta_scalemod_percent("asw_buzzer_beta_scalemod_percent", "1.0", FCVAR_NONE, "Sets the percentage of normal beta buzzers scale.",true,0,true,1);
