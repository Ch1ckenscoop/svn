...
#ifdef IS_WINDOWS_PC
#include "spawn_helper_nut.h"	//softcopy: fix PreSpawnInstance and PostSpawn
#endif
...
void ScriptInstallPreSpawnHook()
{
	...
	{
		g_pScriptVM->Run( g_Script_spawn_helper );	//softcopy: fix missing drones in custom map,  i.e. Orion's elevator area.
	}
#endif
}
