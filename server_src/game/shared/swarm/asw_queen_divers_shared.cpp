...
extern ConVar asw_queen_scalemod;	//Allow scaling the queen and all of her related stuffs
...
void CASW_Queen_Divers::Spawn()
{
	...
	//softcopy:	asw_queen_model_scale is replaced by asw_queen_scalemod
