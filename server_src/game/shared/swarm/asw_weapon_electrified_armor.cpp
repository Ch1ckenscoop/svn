...
ConVar asw_electrified_armor_radius("asw_electrified_armor_radius", "160.0", FCVAR_CHEAT, "Radius of the first shock when activating electrified armor.");
//Ch1ckensCoop: Allow modification of electric armor damage scaling
ConVar asw_marine_electrified_armor_scale("asw_marine_electrified_armor_scale", "0.25", FCVAR_CHEAT, "Scales the amount of damage taken by marines if they are using electrified armor.");
