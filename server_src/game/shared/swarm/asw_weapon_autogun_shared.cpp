...
extern ConVar sk_plr_dmg_asw_ag;
ConVar sk_plr_fr_asw_ag( "sk_plr_fr_asw_ag","0.1", FCVAR_REPLICATED | FCVAR_CHEAT , "Sets the fire rate of the Autogun.");
...
float CASW_Weapon_Autogun::GetWeaponDamage()
{
	...
	float flDamage = sk_plr_dmg_asw_ag.GetFloat();
...
float CASW_Weapon_Autogun::GetFireRate()
{
	//float flRate = GetWeaponInfo()->m_flFireRate;
	float flRate = sk_plr_fr_asw_ag.GetFloat();
