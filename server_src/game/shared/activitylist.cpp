...
void ActivityList_RegisterSharedActivities( void )
{
	...
	//softcopy:
	REGISTER_SHARED_ACTIVITY( ACT_DRONE_TINY_FLINCH );
	REGISTER_SHARED_ACTIVITY( ACT_DRONE_BURROW_OUT );
	REGISTER_SHARED_ACTIVITY( ACT_DRONE_BURROW_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_BURROW_OUT );
	REGISTER_SHARED_ACTIVITY( ACT_BURROW_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_ANTLION_RUN_AGITATED );
